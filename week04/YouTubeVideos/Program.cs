...
class Program
{
    ...
    {
        Video vid1 = new Video("Risk of Rain 2: Full playthrough", "ScottPlayzGamezzz",215);
        Video vid2 = new Video("How to enter a new world via toilet pipes", "M. Brother", 360);
        Video vid3 = new Video("Godzilla: Friend or Foe?", "Kai Ju", 445);
